...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid eclipsim address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid eclipsim address" in e.error['message'])
