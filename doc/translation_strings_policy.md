...
This document provides guidelines for internationalization of the Eclipsim Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `eclipsim_en.ts` remains unchanged.
