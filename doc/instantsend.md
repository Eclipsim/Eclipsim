...
This mechanism has been integrated into Bitcore-Node-Eclipsim which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/eclipsimpay/insight-api-eclipsim#web-socket-api](https://github.com/eclipsimpay/insight-api-eclipsim#web-socket-api)
* API: [https://github.com/eclipsimpay/insight-api-eclipsim#instantsend-transactions](https://github.com/eclipsimpay/insight-api-eclipsim#instantsend-transactions)
...
By default, the Eclipsim Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Eclipsim Core daemon:
