...
official/supported Docker Images found at https://hub.docker.com/r/eclipsimpay/eclipsimd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/eclipsimpay/eclipsimd-develop/ when changing the above text**