...
2. run eclipsimd with -printalert or -sendalert like this:
   /path/to/eclipsimd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.eclipsim.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Eclipsim Core:0.12.0.58/"));
