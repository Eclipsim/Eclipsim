...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in eclipsim.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("eclipsim.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Eclipsim features */
    { "eclipsim",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "eclipsim",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "eclipsim",               "gobject",                &gobject,                true,  {} },
    { "eclipsim",               "voteraw",                &voteraw,                true,  {} },
