...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Eclipsim address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "eclipsim",               "masternode",             &masternode,             true,  {} },
    { "eclipsim",               "masternodelist",         &masternodelist,         true,  {} },
    { "eclipsim",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "eclipsim",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "eclipsim",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "eclipsim",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
