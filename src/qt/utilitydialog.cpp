    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  eclipsim-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Eclipsim in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ECX, 0.1 ECX, 1 ECX and 10 ECX -- sort of like the paper money you use every day.</li> \
