    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ECX-light"), QVariant("light"));
    ui->theme->addItem(QString("ECX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ECX-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("ECX-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("ECX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ECX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ECX-traditional"), QVariant("trad"));
